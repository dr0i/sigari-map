  ...
  L.Control.Ruler = L.Control.extend({
    ...
    _moving: function(e) {
      if (this._clickedLatLong) {
        ...
        this._calculateDistanceAndDistance();
    ...
    _calculateDistanceAndDistance: function() {
      ...
      var distance = R * c;
      // Distance when using a medium
      var medium = distance * this.options.mediumUnit.factor;
      this._result = {
        Medium: medium,
        Distance: distance
      };
